  ...
  ({ className, variant = 'primary', size = 'md', isLoading = false, children, disabled, ...props }, ref) => {
    ...
    return (
      ...
      >
        ...
        {!isButtonDisabled && (
          <div className="absolute inset-0 -z-10 bg-gradient-to-r from-transparent via-white/10 to-transparent opacity-0 hover:opacity-100 transition-all duration-500 transform -skew-x-12 translate-x-[-100%] hover:translate-x-[100%]" />
        )}
      </motion.button>
    )
  }
